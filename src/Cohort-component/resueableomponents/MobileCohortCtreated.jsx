            ...
            <div className="max-w-md mx-auto pt-10">
              ...
              <form class="max-w-md mx-auto">   
                  ...
                  <div class="relative">
                      ...
                      class="text-white absolute end-0 bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 dark:bg-blue-400">Search</button>
                    </div>
              </form>
